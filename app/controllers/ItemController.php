...
class ItemController extends Controller
{
    ...
    // 添加记录，测试 DB记录创建（Create）
    public function add()
    {
        $data['user_name'] = $_POST['value'];
        $data['user_password'] = '123456';
        $data['education'] = '本科';
        $data['telphone'] = '14789653244';
        $data['email'] = '963145127@qq.com';
        $data['create_time'] = '2021-03-01';
    ...
    // 更新记录，测试 DB记录更新（Update）
    public function update()
    {
        $data = array('id' => $_POST['id'], 'user_name' => $_POST['value']);
